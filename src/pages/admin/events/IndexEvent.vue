...
import api from '../../axios' // axios instance dengan token otomatis
      ...
      <div class="bg-white p-6 rounded shadow-md w-96">
        ...
        <form @submit.prevent="updateEvent" class="space-y-2">
          ...
          <div class="flex justify-end space-x-2 mt-4">
            <button type="button" @click="editingEvent = null" class="bg-gray-400 text-white px-3 py-1 rounded">Batal</button>
